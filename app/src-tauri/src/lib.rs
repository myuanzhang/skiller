...
fn build_tray_menu_from_data<R: tauri::Runtime>(
    ...
    let app_name = MenuItem::with_id(app, "tray-app-name", "Skiller", false, None::<&str>)?;
    ...
    let show_item = MenuItem::with_id(app, "show", "Open Skiller", true, None::<&str>)?;
    ...
    tauri::async_runtime::spawn(async move {
        ...
        let result = tauri::async_runtime::spawn_blocking(move || {
            ...
            let ids: Vec<String> = store_for_task
                ...
                .collect();
            for skill_id in ids {
                // Brief yield between checks to avoid saturating network/disk.
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::skills::get_skill_usage_stats,
            ...
            commands::skills::open_skill_local_copy,
