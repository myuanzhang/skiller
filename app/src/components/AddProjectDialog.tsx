          ...
          <div className="space-y-3">
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-2.5 rounded-control border border-border-subtle bg-background text-muted hover:text-secondary hover:border-border transition-all outline-none"
