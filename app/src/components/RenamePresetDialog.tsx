...
export function RenamePresetDialog({
  ...
  const inputClass = "w-full bg-background border border-border-subtle rounded-control px-3 py-2 text-[13px] text-secondary focus:outline-none focus:border-border transition-all placeholder-faint";
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-end gap-2 pt-1">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-control bg-accent-dark hover:bg-accent text-white text-[13px] font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed border border-accent-border outline-none"
            >
